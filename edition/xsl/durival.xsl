...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    *******************************************************************
    ...
    <xsl:template match="/">
                        ...
                        <div class="nav" data-sticky="true" data-options="marginTop:0;">
                            ...
                            <div class="top-bar" id="menu-responsive">
                                ...
                                <div class="top-bar-right">
                                    <ul class="vertical medium-horizontal menu" data-responsive-menu="drilldown medium-dropdown">
                                        <li>
                                            <a href="html/query.php">Recherche</a>
                                        </li>
                                        <li>
                                            <a href="#">Index</a>
                                            <ul class="vertical menu">
        ...
        <xsl:apply-templates select="." mode="searchEngine"/>
...
<!--   ENU AJOUT REF dans le MATCH POUR NE PAS AFFICHER LES INDEX  SANS REF (not(@ref)-->    
    <xsl:template match="tei:div[@type='transcription']//tei:persName[@ref] | tei:div[@type='transcription']//tei:rs[@type='person'][@ref]">
    ...
    <xsl:include href="include/searchEngine.xsl"/>
